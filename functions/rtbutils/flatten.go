...
func _flatten(out KeyValue, obj interface{}, key JSONPointer) error {
...
func _flattenMap(out map[string]interface{}, value reflect.Value, prefix JSONPointer) {
...
func _flattenSlice(out map[string]interface{}, value reflect.Value, prefix JSONPointer) {
