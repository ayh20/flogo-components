# f1telemetry
This activity Decodes telemetry data from Codemasters F1-2021, and places it in to a "CSV" "record". 
This is designed as a demonstration for integrating F1 2021 .. Flogo .... TIBCO Streambase and TIBCO Spotfire/Liveview
...
Information about the format of the raw data can be found here: https://forums.codemasters.com/topic/80231-f1-2021-udp-specification/
...
```bash
flogo install github.com/ayh20/flogo-components/activity/f1telemetry2021
```
